...
public class EventReportActivity extends AppCompatActivity {
    ...
    private EditText mdate_time_in;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mdate_time_in = (EditText) findViewById(R.id.date_time_input);
        ...
        mdate_time_in.setInputType(InputType.TYPE_NULL);
        ...
        mdate_time_in.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ShowDateTimeDialog(mdate_time_in);
            }
        });
    ...
    private void ShowDateTimeDialog(final EditText mdate_time_in) {
            ...
            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                ...
                TimePickerDialog.OnTimeSetListener timeSetListener= new TimePickerDialog.OnTimeSetListener() {
                    ...
                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                        ...
                        mdate_time_in.setText(simpleDateFormat.format(calender));
                    }
                };

                new TimePickerDialog(EventReportActivity.this,timeSetListener,calender.get(Calendar.HOUR_OF_DAY),calender.get(Calendar.MINUTE),false).show();
            }
        };
        new DatePickerDialog(EventReportActivity.this, dateSetListener,calender.get(Calendar.YEAR),calender.get(Calendar.MONTH),calender.get(Calendar.DAY_OF_MONTH)).show();
    }
    /**
    ...
    private String uploadEvent() {
     ...
     //   Long time = Long.valueOf(mdate_time_in.getText().toString()); // seting date and time
